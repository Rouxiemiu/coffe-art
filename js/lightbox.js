...
var metLightbox ={
	...
	lightbox:function(imagen) {
		propLightbox.imagenSrc = window.getComputedStyle(imagen, null).backgroundImage.slice(4, -1);
		...
		propLightbox.modal.innerHTML += '<i id="cerrar_modal" class="far fa-times-circle"></i>';
